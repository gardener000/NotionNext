...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Gardener', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notionnext-rust.vercel.app/', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '纷纷万事，直道而行, 我心里有一簇迎着烈日而生的花,Hi，我是Gardener,欢迎来到我的博客🎉',
